!function(e, t) {
    ...
    e.default = void 0,
    "undefined" == typeof NodeList || NodeList.prototype.forEach || (NodeList.prototype.forEach = function(e, t) {
        t = t || window;
    ...
    var s = function() {
        function D(e) {
            ...
            var n = (new Date).getFullYear()
              , a = 0;
            this.options.startDate ? (n = this.options.startDate.getFullYear(),
            a = this.options.startDate.getMonth()) : this.options.startYear && (n = this.options.startYear),
        ...
        (t = [{
            ...
            value: function(e) {
                ...
                this.options.dataSource instanceof Array && (this._dataSource = this.options.dataSource,
            ...
            value: function() {
                ...
                if (this.options.displayHeader && this._renderHeader(),
                e)
                    this._renderLoading();
                else {
                    this._renderBody(),
            ...
            value: function() {
                ...
                null != this.options.minDate && this.options.minDate >= n.startDate && a.classList.add("disabled");
                var i = document.createElement("span");
                if (i.innerHTML = "&lsaquo;",
                a.appendChild(i),
                t.appendChild(a),
                ...
                if (r.classList.add("year-title"),
                this._isFullYearMode() ? r.textContent = this._startDate.getFullYear().toString() : 12 == this.options.numberMonthsDisplayed ? r.textContent = "".concat(n.startDate.getFullYear(), " - ").concat(n.endDate.getFullYear()) : 1 < this.options.numberMonthsDisplayed ? r.textContent = "".concat(D.locales[this.options.language].months[n.startDate.getMonth()], " ").concat(n.startDate.getFullYear(), " - ").concat(D.locales[this.options.language].months[n.endDate.getMonth()], " ").concat(n.endDate.getFullYear()) : r.textContent = "".concat(D.locales[this.options.language].months[n.startDate.getMonth()], " ").concat(n.startDate.getFullYear()),
                t.appendChild(r),
                this._isFullYearMode()) {
                ...
                null != this.options.maxDate && this.options.maxDate <= n.endDate && u.classList.add("disabled");
            ...
            value: function() {
                ...
                for (var t = new Date(this._startDate.getTime()), n = 0; n < this.options.numberMonthsDisplayed; n++) {
                    ...
                    this._nbCols && a.classList.add("month-".concat(this._nbCols));
                    ...
                    r.setAttribute("colspan", this.options.displayWeekNumber ? "8" : "7"),
                    r.textContent = D.locales[this.options.language].months[t.getMonth()],
                    o.appendChild(r),
                    s.appendChild(o);
                    var l = document.createElement("tr");
                    if (this.options.displayWeekNumber)
                        (y = document.createElement("th")).classList.add("week-number"),
                        y.textContent = D.locales[this.options.language].weekShort,
                        l.appendChild(y);
                    ...
                    do {
                        ...
                        c.textContent = D.locales[this.options.language].daysMin[u],
                    ...
                    s.appendChild(l),
                    i.appendChild(s);
                    for (var h = new Date(t.getTime()), p = new Date(t.getFullYear(),t.getMonth() + 1,0); h.getDay() != d; )
                    ...
                    for (; h <= p; ) {
                        ...
                        do {
                            ...
                            h < t)
                                ...
                                f.appendChild(v),
                                this.options.customDayRenderer && this.options.customDayRenderer(v, h)
                            }
                            g.appendChild(f),
                            h.setDate(h.getDate() + 1)
                        } while (h.getDay() != d);
            ...
            value: function() {
                ...
                if (t.classList.add("calendar-loading"),
                this.options.loadingTemplate)
                    ...
                    for (var a = 1; a <= 3; a++) {
                        ...
                        i.classList.add("bounce".concat(a)),
                        n.appendChild(i)
                    }
                    t.appendChild(n)
                }
                ...
                null != this._dataSource && 0 < this._dataSource.length && this.element.querySelectorAll(".month-container").forEach(function(e) {
                    ...
                    if ((null == l.options.minDate || a > l.options.minDate) && (null == l.options.maxDate || n <= l.options.maxDate)) {
                        for (var r = [], i = 0; i < l._dataSource.length; i++)
                            l._dataSource[i].startDate >= a && !(l._dataSource[i].endDate < n) || r.push(l._dataSource[i]);
                        0 < r.length && e.querySelectorAll(".day-content").forEach(function(e) {
                            ...
                            if ((null == l.options.minDate || t >= l.options.minDate) && (null == l.options.maxDate || t <= l.options.maxDate)) {
                                for (var i = 0; i < r.length; i++)
                                    r[i].startDate < n && r[i].endDate >= t && a.push(r[i]);
            ...
            value: function(e, t, n) {
                ...
                case "border":
                    var i = 0;
                    if (1 == n.length ? i = 4 : n.length <= 3 ? i = 2 : a.style.boxShadow = "inset 0 -4px 0 0 black",
                    0 < i) {
                        for (var s = "", o = 0; o < n.length; o++)
                            "" != s && (s += ","),
                            s += "inset 0 -".concat((o + 1) * i, "px 0 0 ").concat(n[o].color);
                        a.style.boxShadow = s
                    }
                    break;
                case "background":
                    ...
                    if (n[n.length - 1].startDate.getTime() == r)
                        ...
                        n[n.length - 1].startHalfDay || this.options.alwaysHalfDay) {
                            ...
                            this.options.roundRangeLimits && a.classList.add("round-left");
                    else if (n[n.length - 1].endDate.getTime() == r)
                        if (a.classList.add("day-end"),
                        n[n.length - 1].endHalfDay || this.options.alwaysHalfDay) {
                            ...
                            this.options.roundRangeLimits && a.classList.add("round-right");
                    break;
                case "custom":
            ...
            value: function() {
                ...
                this.element.querySelectorAll(".day:not(.old):not(.new):not(.disabled)").forEach(function(e) {
                    ...
                    e.addEventListener("contextmenu", function(e) {
                        s.options.enableContextMenu && (e.preventDefault(),
                        0 < s.options.contextMenuItems.length && s._openContextMenu(e.currentTarget));
                        var t = s._getDate(e.currentTarget);
                    ...
                    s.options.enableRangeSelection && (e.addEventListener("mousedown", function(e) {
                        if (1 == e.which) {
                            var t = s._getDate(e.currentTarget);
                            (s.options.allowOverlap || s.isThereFreeSlot(t)) && (s._mouseDown = !0,
                    ...
                    e.addEventListener("mouseenter", function(e) {
                        if (s._mouseDown) {
                            ...
                            if (!s.options.allowOverlap) {
                                ...
                                if (n < t)
                                    for (var a = new Date(n.getFullYear(),n.getMonth(),n.getDate() + 1); n < t && s.isThereFreeSlot(a, !1); )
                                        n.setDate(n.getDate() + 1),
                                        a.setDate(a.getDate() + 1);
                                else
                                    for (a = new Date(n.getFullYear(),n.getMonth(),n.getDate() - 1); t < n && s.isThereFreeSlot(a, !0); )
                                        n.setDate(n.getDate() - 1),
                                        a.setDate(a.getDate() - 1);
                                t = n
                            }
                            var i = s._rangeEnd;
                            s._rangeEnd = t,
                            i.getTime() != s._rangeEnd.getTime() && s._refreshRange()
                        }
                    })),
                    e.addEventListener("mouseenter", function(e) {
                        if (!s._mouseDown) {
                ...
                this._responsiveInterval && (clearInterval(this._responsiveInterval),
                ...
                this._responsiveInterval = setInterval(function() {
                    if (null != s.element.querySelector(".month")) {
                        ...
                        s._nbCols = null,
                        6 * t < e && 6 <= s.options.numberMonthsDisplayed ? s._nbCols = 2 : 4 * t < e && 4 <= s.options.numberMonthsDisplayed ? s._nbCols = 3 : 3 * t < e && 3 <= s.options.numberMonthsDisplayed ? s._nbCols = 4 : 2 * t < e && 2 <= s.options.numberMonthsDisplayed ? s._nbCols = 6 : s._nbCols = 12,
            ...
            value: function() {
                ...
                this._mouseDown) {
                    ...
                    this.element.querySelectorAll(".month-container").forEach(function(e) {
                        ...
                        s.getTime() < a.getTime() && o.getTime() >= n.getTime() && e.querySelectorAll("td.day:not(.old):not(.new)").forEach(function(e) {
                            var t = i._getDate(e);
                            s <= t && t <= o && (e.classList.add("range"),
                            t.getTime() == s.getTime() && e.classList.add("range-start"),
                            t.getTime() == o.getTime() && e.classList.add("range-end"))
                        })
                    })
                }
            }
            ...
            value: function(e) {
                ...
                if (null !== n)
                    ...
                    (n = document.createElement("div")).classList.add("calendar-context-menu"),
                ...
                if (0 < n.children.length) {
                    ...
                    n.getBoundingClientRect().right > document.body.offsetWidth && (n.style.left = "",
                    n.style.right = "0"),
                    setTimeout(function() {
                        return t._checkContextMenuItemsPosition()
                    }, 0);
                    var c = function e(t) {
                        "click" === t.type && n.contains(t.target) || (n.style.display = "none",
            ...
            value: function(e, t) {
                var n = null;
                for (var a in "function" == typeof Event ? n = new Event(e) : (n = document.createEvent("Event")).initEvent(e, !1, !1),
                n.calendar = this,
                t)
                    n[a] = t[a];
                return this.element.dispatchEvent(n),
                n
            }
        }, {
            key: "_isDisabled",
            value: function(e) {
                if (null != this.options.minDate && e < this.options.minDate || null != this.options.maxDate && e > this.options.maxDate)
                    return !0;
                if (0 < this.options.disabledWeekDays.length)
                    for (var t = 0; t < this.options.disabledWeekDays.length; t++)
                        if (e.getDay() == this.options.disabledWeekDays[t])
                            return !0;
            ...
            value: function(e) {
                if (0 < this.options.hiddenWeekDays.length)
                    for (var t = 0; t < this.options.hiddenWeekDays.length; t++)
                        if (e == this.options.hiddenWeekDays[t])
                            return !0;
                return !1
            }
        }, {
            ...
            value: function() {
                ...
                return t.setMonth(t.getMonth() + this.options.numberMonthsDisplayed),
            ...
            value: function(e) {
                ...
                if (e instanceof Date) {
                    for (this.options.startDate = e,
                    this._startDate = new Date(e.getFullYear(),e.getMonth(),1); this.element.firstChild; )
                        this.element.removeChild(this.element.firstChild);
                    ...
                    var n = this.getCurrentPeriod()
                      ...
                      , i = null;
                    this._isFullYearMode() && (i = this._triggerEvent("yearChanged", {
                        currentYear: this._startDate.getFullYear(),
                        preventRendering: !1
                    })),
                    "function" == typeof this.options.dataSource ? (this.render(!0),
            ...
            value: function(e) {
                var t = 1 < arguments.length && void 0 !== arguments[1] && arguments[1]
                  , n = parseInt(e);
                !isNaN(n) && 0 < n && n <= 12 && (this.options.numberMonthsDisplayed = n,
                t || this.render())
            }
        }, {
            key: "getMinDate",
            ...
            value: function(e) {
                var t = 1 < arguments.length && void 0 !== arguments[1] && arguments[1];
                (e instanceof Date || null === e) && (this.options.minDate = e,
                t || this.render())
            }
        }, {
            key: "getMaxDate",
            ...
            value: function(e) {
                var t = 1 < arguments.length && void 0 !== arguments[1] && arguments[1];
                (e instanceof Date || null === e) && (this.options.maxDate = e,
                t || this.render())
            }
        }, {
            key: "getStyle",
            ...
            value: function(e) {
                var t = 1 < arguments.length && void 0 !== arguments[1] && arguments[1];
                this.options.displayDisabledDataSource = e,
                t || this.render()
            }
        }, {
            ...
            value: function(e) {
                var t = 1 < arguments.length && void 0 !== arguments[1] && arguments[1];
                this.options.customDayRenderer = "function" == typeof e ? e : null,
                t || this.render()
            }
        }, {
            ...
            value: function(e) {
                var t = 1 < arguments.length && void 0 !== arguments[1] && arguments[1];
                this.options.customDataSourceRenderer = "function" == typeof e ? e : null,
                t || this.render()
            }
        }, {
            key: "getLanguage",
            ...
            value: function(e) {
                var t = 1 < arguments.length && void 0 !== arguments[1] && arguments[1];
                null != e && null != D.locales[e] && (this.options.language = e,
                t || this.render())
            }
        }, {
            key: "getDataSource",
            ...
            value: function(e) {
                var t = 1 < arguments.length && void 0 !== arguments[1] && arguments[1];
                this.options.weekStart = isNaN(parseInt(e)) ? null : parseInt(e),
                t || this.render()
            }
        }, {
    ...
    "object" === ("undefined" == typeof window ? "undefined" : t(window)) && (window.Calendar = s,
